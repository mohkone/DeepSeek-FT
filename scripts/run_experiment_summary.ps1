param(
  ...
  [string]$Pbmc3kScTypePredictions = "outputs/pbmc3k.sctype.jsonl",
  [string]$Pbmc3kScTypeHarmonizedPredictions = "outputs/pbmc3k.sctype.harmonized.jsonl",
  ...
  [string]$BaronScTypePredictions = "outputs/baron_pancreas.sctype.jsonl",
  [string]$BaronScTypeHarmonizedPredictions = "outputs/baron_pancreas.sctype.harmonized.jsonl",
  ...
  [string]$ZeiselScTypePredictions = "outputs/zeisel_brain.sctype.jsonl",
  [string]$ZeiselScTypeHarmonizedPredictions = "outputs/zeisel_brain.sctype.harmonized.jsonl",
...
try {
  ...
  $optionalPredictions = @(
    ...
    @("pbmc3k_matrix_sctype", $Pbmc3kScTypePredictions),
    @("pbmc3k_matrix_sctype_harmonized", $Pbmc3kScTypeHarmonizedPredictions),
    ...
    @("baron_pancreas_matrix_sctype", $BaronScTypePredictions),
    @("baron_pancreas_matrix_sctype_harmonized", $BaronScTypeHarmonizedPredictions),
    ...
    @("zeisel_brain_matrix_sctype", $ZeiselScTypePredictions),
    @("zeisel_brain_matrix_sctype_harmonized", $ZeiselScTypeHarmonizedPredictions),
